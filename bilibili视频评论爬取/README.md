...
![image](https://user-images.githubusercontent.com/87558103/235108670-8fd299de-6266-4e49-9971-7618427c819c.png)
...
添加随机延时：          
先`import random`                    
在想要延时的地方写`time.sleep(random.uniform(1, 5))  # 随机生成1到5秒之间的延时，具体秒数可根据需要修改`
